...
class FieldInfo:
    ...
    editable_upon_add:  bool = True            # allow input in Add dialog
    editable_upon_update: bool = True            # allow input in Edit dialog
    can_auto_fill:    bool = False           # fields that can auto fill upon adding/editing
    ...
    def to_dict(self) -> Dict[str, Any]:
        data = {
            ...
            'editable_upon_add':  self.editable_upon_add,
            'editable_upon_update': self.editable_upon_update,
...
class CustomerField(Enum):
    ...
    CUSTOMER_STATUS = FieldInfo(
        ...
        placeholder='Active',
        editable_upon_add=False,   # defaults to 'Active' on insert
        editable_upon_update=True,   # user can toggle Active <-> Blacklisted
    )
...
class RentField(Enum):
    ...
    CUSTOMER_ID = FieldInfo(
        ...
        editable_upon_update=False,  # locked after creation
    )
    UNIT_ID = FieldInfo(
        'unitID', 'Unit',
        type=FieldType.SELECT_ID,
    ...
    RENT_STATUS = FieldInfo(
        ...
        placeholder='Ongoing',
        editable_upon_add=False,   # system sets to 'Ongoing' on creation
        editable_upon_update=False,  # system-managed (closes on return)
    )
    ...
    ACTUAL_RETURN_DATETIME = FieldInfo(
        ...
        required=False,
        placeholder='YYYY-MM-DD HH:MM:SS',
        editable_upon_add=False,   # hidden on Add; filled when unit is returned
        editable_upon_update=False
    )
    RENT_FEE = FieldInfo(
        'rentFee', 'Rent Fee (₱)',
        type=FieldType.REAL,
        ...
        editable_upon_add=True,   # auto-calculated: dailyRate × days
        editable_upon_update=False,  # immutable after creation
        can_auto_fill=True
        # same case as primary key (generated after insert)
    )
...
class LiabilityField(Enum):
    ...
    LIABILITY_STATUS = FieldInfo(
        ...
        editable_upon_add=False,   # defaults to 'Pending' on creation
        editable_upon_update=True,   # user can mark as Settled
    )
