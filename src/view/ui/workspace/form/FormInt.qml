...
ColumnLayout {
    ...
    TextField {
        ...
        background: Rectangle {
            ...
            border { color: field.activeFocus ? appTheme.activeColor : "#888888"; width: field.activeFocus ? 2 : 0.75 }
        }

        HoverHandler { id: hover }
        transform: Translate { y: hover.hovered ? -2 : 0; Behavior on y { NumberAnimation { duration: 150; easing.type: Easing.OutQuad } } }
